...
typedef struct _BPU_T_GF2_QC_Matrix {
  ...
  uint16_t row_element_count; ///< number of cyclic matrices (in row)
  uint16_t column_element_count; ///< number of cyclic matrices (in column)
...
int BPU_gf2QcMultirowMatrixMalloc(BPU_T_GF2_QC_Matrix *v, int element_count, int element_dimension, int element_size);
