...
int BPU_gf2QcMatrixMalloc(BPU_T_GF2_QC_Matrix *v, int element_count, int element_size, int isVertical, int is_I_appended) {
  ...
  // set others
  v->column_element_count = 1;
  v->row_element_count = element_count;
  v->element_size = element_size;
...
int BPU_gf2QcMultirowMatrixMalloc(BPU_T_GF2_QC_Matrix *v, int row_element_count, int column_element_count, int element_size) {
  int err = 0;
  ...
  // set others
  v->row_element_count = row_element_count;
  v->column_element_count = column_element_count;
  v->element_size = element_size;
  v->is_I_appended = 0;
  v->isVertical = 0;
...
void BPU_gf2QcMatrixFree(BPU_T_GF2_QC_Matrix *v, int is_dyn) {
  ...
  // free matrices
  for (i = 0; i < v->row_element_count * v->column_element_count; i++) {
